      ...
      <div className="space-y-6">
        ...
        <div className="relative rounded-2xl overflow-hidden group cursor-pointer">
          ...
          <div className="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-colors flex items-center justify-center">
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-locked flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform">
              <Lock className="w-8 h-8 md:w-10 md:h-10 text-locked-foreground" />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          {modules.map((module) => (
            ...
            >
              ...
              <Lock className="w-5 h-5 text-locked-foreground flex-shrink-0" />
            </div>
          ))}
        </div>
